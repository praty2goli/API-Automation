/**
 * 
 * PropertyConfiguration class used to Get values from config file.
 */
...
public class PropertyConfiguration {
	private static PropertyConfiguration _instance = null;
	public Properties testData;
	public InputStream fileConfig = null;

	/**
	 * Constructor of PropertyConfiguration class to load config files
	 */
	 ...
	 * new instance of PropertyConfiguration
	 * 
	 * @return PropertyConfiguration class instance
	 */
	public static synchronized PropertyConfiguration getInstance() {

		if (_instance == null) {
			_instance = new PropertyConfiguration();
		}
		return _instance;
	}
